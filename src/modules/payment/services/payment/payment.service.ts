    ...
    try {
      ...
      if (!sender) {
        throw new NotFoundException(
          'Falta el parametro sender, que es un string.',
        );
      }
      ...
      if (!token) {
        throw new NotFoundException(
          'Falta el parametro token, que es un string.',
        );
      }
      ...
      if (!amount) {
        throw new NotFoundException(
          'Falta el parametro amount, que es un string.',
        );
      }
      ...
      if (!receiverWallet) {
        throw new NotFoundException(
          'Receiver wallet no encontrada en la base de datos.',
        );
      }
